      ...
      {isBusy && canSearch && (
        <p className={`${styles.statusCard} ${styles.loading}`}>
          <span className={styles.loadingText}>
            Searching for <b className={styles.queryPill}>"{query}"</b>
      ...
      {!isBusy && canSearch && !hasFailed && (
        <div className={styles.resultsMeta}>
          <p className={styles.resultsLabel}>
            Results for <span className={styles.queryPill}>"{query}"</span>
          </p>
          <p className={styles.resultsCount}>
            <span className={styles.countPill}>{total}</span> found
          </p>
        </div>
      )}
